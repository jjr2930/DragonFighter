...
public class JAnimatorController : MonoBehaviour {
    ...
    void ProcessBackBtn(GameObject go)
    {
        ...
        m_fCurSpeed = Mathf.Clamp(m_fCurSpeed, Configure.Instance.PLAYER_BACKSPEED_LIMIT, 0f);
    ...
    void ProcessLeftBtn(GameObject go)
    {
        ...
        m_fCurStrafe = Mathf.Clamp(m_fCurStrafe, 0f, Configure.Instance.PLAYER_STRAFE_LIMIT);
